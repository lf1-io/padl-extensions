...
class PadlLightning(pl.LightningModule):
    ...
    def train_dataloader(self):
        ...
        using :meth:`~padl.transforms.Transform.pd_get_loader` if `self.train_data` is provided.
        """
    ...
    def val_dataloader(self):
        ...
        using :meth:`~padl.transforms.Transform.pd_get_loader` if `self.val_data` is provided.
        """
    ...
    def test_dataloader(self):
        ...
        using :meth:`~padl.transforms.Transform.pd_get_loader` if `self.test_data` is provided.
        """
    ...
    def training_step(self, batch, batch_idx):
        """Default training step overwritten from :class:`~pl.LightningModule.training_step`.
    ...
    def validation_step(self, batch, batch_idx):
        """Default validation step overwritten from :class:`~pl.LightningModule.validation_step`.
    ...
    def test_step(self, batch, batch_idx):
        """Default test step overwritten from :meth:`~pl.LightningModule.test_step`.
    ...
    def on_save_checkpoint(self, checkpoint):
        ...
        Adding PADL saving by implementing the :meth:`~pl.LightningModule.on_save_checkpoint`
        callback and calling :meth:~`self.padl_model.save`. This works in addition to the
        :class:`~pl.callbacks.ModelCheckpoint` callback which will still save the pytorch
        lightning ckpt file.
    ...
    def configure_optimizers(self):
        """Implementation of the inherited method :meth:`~pl.LightningModule.configure_optimizers`.
